...
##################################################
	...
	for indx in range(0,len(ograte)):
		newcount0, newcount1 = 0,0
		...
		for num in numbers:
			...
			if newcount1 >= newcount0:
				ograte[indx] = 1
			else:
				ograte[indx] = 0

		print(f"new index {indx} is {ograte[indx]}")
...
for a in range(0,len(c02rate)):
	...
	if len(numbers2) == 1:
		print(f"c02 from loops is {c02rate}")
